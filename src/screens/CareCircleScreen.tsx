...
export function CareCircleScreen() {
  ...
  const createConnectionMutation = useMutation({
    mutationFn: ({ inviteCode, role }: { inviteCode: string; role: CareCircleRole }) =>
  ...
  return (
    <Screen>
      <HeaderBar
        title={
          tab === 'enter-code' ? 'Connect Someone\nto Your Circle' : 'Choose Your Role'
        }
        subtitle={
          tab === 'enter-code'
        ...
        {tab === 'enter-code' && (
          <View>
            ...
            <View style={{ marginVertical: 24 }}>
              <Typography
                variant="helper"
                style={{ textAlign: 'center', color: isDark ? '#9B7E8C' : '#BFAEB8' }}
              >
                OR
              </Typography>
            </View>
