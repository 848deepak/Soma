    ...
    <Animated.View
                  ...
                  className={`h-9 w-9 items-center justify-center rounded-full ${
                    isSelected
                      ...
                      : isPeriod
                        ...
                        : isOvulation
                          ? 'border-2 border-somaPeach bg-somaPeach/70 dark:border-darkAccent dark:bg-darkSecondary/70'
                          : isFertile
                            ? 'bg-somaPeach/60 dark:bg-darkBorder'
                            : 'bg-transparent'
                  }`}>
                  <Typography
                    className={`text-[14px] ${
      ...
      <View className="mt-4 flex-row items-center justify-between rounded-2xl bg-somaGlow/60 px-4 py-3 dark:bg-darkCard">
        <View className="flex-row items-center gap-2">
          <View className="h-3 w-3 rounded-full bg-somaBlush" />
          <Typography variant="helper">Period</Typography>
        </View>
        <View className="flex-row items-center gap-2">
          <View className="h-3 w-3 rounded-full bg-somaPeach" />
          <Typography variant="helper">Fertile</Typography>
        </View>
        <View className="flex-row items-center gap-2">
          <View className="h-3 w-3 rounded-full border border-somaPeach" />
