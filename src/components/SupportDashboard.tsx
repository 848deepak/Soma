...
export function SupportDashboard({
  ...
  const phaseInfo = CYCLE_PHASE_LABELS[cyclePhase] || CYCLE_PHASE_LABELS.follicular;
  const suggestions = SUPPORT_SUGGESTIONS[cyclePhase] || SUPPORT_SUGGESTIONS.follicular;
  ...
  return (
    <View style={{ gap: 16, marginTop: 32 }}>
      ...
      >
        ...
        {today?.predicted_next_cycle && (
          <Typography
            ...
            style={{
              textAlign: 'center',
              color: isDark ? 'rgba(242,242,242,0.6)' : '#9B7E8C',
            }}
          >
      ...
      {today?.partner_alert && (
        <View
          style={{
            ...
            borderWidth: 1,
            borderColor: '#DDA7A5',
            backgroundColor: 'rgba(221,167,165,0.12)',
            padding: 16,
          }}
        >
      ...
      >
        <Typography style={{ fontSize: 13, fontWeight: '600', marginBottom: 12 }}>
          How You Can Support
        </Typography>
        <View style={{ gap: 8 }}>
            ...
            <View key={i} style={{ flexDirection: 'row', gap: 12, alignItems: 'flex-start' }}>
              ...
              <Typography
                style={{
                  flex: 1,
                  fontSize: 13,
                  color: isDark ? 'rgba(242,242,242,0.8)' : '#2D2327',
                  lineHeight: 18,
                }}
              >
                {suggestion}
      ...
      <Typography
        ...
        style={{
          textAlign: 'center',
          fontSize: 11,
          color: isDark ? 'rgba(242,242,242,0.5)' : '#BFAEB8',
          marginTop: 8,
        }}
      >
        You are viewing as a Supporter. This is read-only and updated in real-time.
      </Typography>
    </View>
  );
}
